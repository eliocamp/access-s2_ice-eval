...
```{r extent-delta, fig.height=11.99/cm, fig.width=23.59/cm}
...
```{r bias_S2_0, fig.width=width_bias, fig.height=height_bias}
hindcast_clim |> 
  bias_plot("S2", 0)
```

```{r bias_S1_0, fig.width=width_bias, fig.height=height_bias}
hindcast_clim |> 
  bias_plot("S1", 0)
```

lead
```{r bias_S2_6, fig.width=width_bias, fig.height=height_bias}
hindcast_clim |> 
  bias_plot("S2", 6)

```

```{r bias_S1_6, fig.width=width_bias, fig.height=height_bias}
hindcast_clim |> 
  bias_plot("S1", 6)
```
