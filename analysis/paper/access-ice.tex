...
added to the first ice category with a fixed thickness of 50 cm. If
thhey are negative, they are removed from the thinnest category first
and from thicker categories if needed. Therefore, although this system
only assimilates sea-ice concentration data, sea-ice thickness is
noneless modified.
