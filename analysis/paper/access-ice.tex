...
\hypersetup{
  ...
  pdfauthor={Elio Campitelli; Ariaan Purich; Julie Arblaster; Eun-Pa Lim; Mathew Wheeler; Phillip Reid},
...
% author setup
\author*[1,2]{\fnm{Elio} \sur{Campitelli}}\email{elio.campitelli@monash.edu}\author[1,2]{\fnm{Ariaan} \sur{Purich}}\author[1,2]{\fnm{Julie} \sur{Arblaster}}\author[3]{\fnm{Eun-Pa} \sur{Lim}}\author[3]{\fnm{Mathew} \sur{Wheeler}}\author[3]{\fnm{Phillip} \sur{Reid}}
% affil setup
...
for ACCESS-S1 (column 1; green) and ACCESS-S1 (column 2; purple). Mean
sea-ice extent from NOAA/NSIDC CDRV4 in each corresponding hindcast
