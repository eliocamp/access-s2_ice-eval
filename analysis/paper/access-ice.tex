...
\urlstyle{same}
\hypersetup{
  pdftitle={Evaluating the Importance of Initial Conditions for Antarctic Sea Ice Seasonal Predictability with a Fully Coupled Forecast Model},
...
Ice Seasonal Predictability with a Fully Coupled Forecast
Model]{Evaluating the Importance of Initial Conditions for Antarctic Sea
Ice Seasonal Predictability with a Fully Coupled Forecast Model}
...
\affil[3]{\orgdiv{Research, Bureau of Meteorology, Australia}}
...
ACCESS-S1 does.\\
This provides an convenient opportunistic experiment to assess the role
...
nine ensemble members built from three consecutive three-member
forecasts created in the same manner as ACCESS-S1 members initialised at
the first of every month and the two previous days and run for 279 days.
...
time and only approaches the observed value at nine month lead time for
most months.
...
the effect seems to be stronger more to the east. In West Antarctica
...
over East Antarctica. From July to December even though the
...
West Antarctica. Since oceanic and atmospheric forcing is the only
...
more important for atmospheric circulation also suggest the influence of
...
equilimbrium state. We suggest that the thinner sea ice in ACCESS-S2
...
to three months with, February initial conditions in particular are
shown to be crucial for determining sea-ice evolution at least up to
May. Arctic sea-ice forecasts also show greater sensitivity to initial
conditions in boreal summer, compared with boreal winter
\citep{day2014, bunzel2016}, suggesting a similar mechanism might be
playing a role.

Forecasts initialised in winter have very little skill and ACCESS-S1 and
ACCESS-S2 forecast errors are not statistically different after just two
weeks. This is consistent with the findings of \citet{libera2022}'s
finding of a ``winter predictability barrier'' in the Weddell Sea,
although they describe the barrier as sharp loss of predictability in
July, and here we find a gradual reduction in skill compared with
climatology around June. This difference might be due to our use of
pan-Antarctic RMSE, since our regional analysis indicates that the
degraded skill is most dramatic in the King Haakon sea.
