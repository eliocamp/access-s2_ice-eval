...
Bigger ensambles were generated aggregating several three-member ensembles initialised on successive days [@wedd2022]. 
...
Between January and March, which are the months in which +S1 is the most skillfuil (@fig-lead-time-window), most of the improvement compared with +S2 is present in the Ross and Weddell Sea. 
...
This work benefited by earlier unpublished work by Laura Davies, Phil Reid, Andrew G. Marshall. 
