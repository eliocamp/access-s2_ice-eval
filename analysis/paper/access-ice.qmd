...
Finally, @fig-rmse_lon-3 shows the difference in skill between +S1 and +S2. 
...
Raw data of +S1 and +S2 forecasts are not available due to size. 
Derived datasets required to reproduce the results are available in this Zenodo repository: https://zenodo.org/records/17479538 [@campitelli2025]
